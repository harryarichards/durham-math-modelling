...
class BrusselatorPDE(PDE_RK4):
  ...
  def __init__(self, L, N, t0, Du, Dv, a, b):
      ...
      self.u0=  self.a# TO DO
      self.v0=  self.b/self.a# TO DO
  ...
  def plot_v_u(self, fname=""):
      ...
      plt.plot(x, self.l_f[fig][0:2*self.N:2], "k-")
      plt.plot(x, self.l_f[fig][1:2*self.N:2], "b-")
